...
%         figure; hold on; plot(w_grid,es,'-o'); plot(w_grid,zeros(size(w_grid))); hold off; xlim([w_grid(1) w_grid(end)]);
    ...
    [price_residual_exp,mDBN_W_exp,mDBN_E_exp,mAp_W_exp,mAp_E_exp,OC_W_exp,OC_E1_exp,OC_E2_exp,V_W_exp,V_E_exp,Transition_exp] = Find_DBN_Histogram(x,'bisection') ;
    disp('price residual'); disp(price_residual_exp);
    
    
    [A_exp,K_exp,N_exp,Y_exp,Earnings_W_exp,Earnings_E_exp] = ...
        Graphs_Tables('exp',r_exp,w_exp,mDBN_W_exp,mDBN_E_exp,mAp_W_exp,mAp_E_exp,OC_W_exp,OC_E1_exp,OC_E2_exp,V_W_exp,V_E_exp,Transition_exp) ;
...
%         figure; hold on; plot(w_grid,es,'-o'); plot(w_grid,zeros(size(w_grid))); hold off; xlim([w_grid(1) w_grid(end)]);
    ...
    % Get Distribution, Value and Policy Functions
    [price_residual_exp2,mDBN_W_exp2,mDBN_E_exp2,mAp_W_exp2,mAp_E_exp2,OC_W_exp2,OC_E1_exp2,OC_E2_exp2,V_W_exp2,V_E_exp2,Transition_exp2] = Find_DBN_Histogram(x,'bisection') ;
    disp('price residual'); disp(price_residual_exp2);
    
    
    [A_exp2,K_exp2,N_exp2,Y_exp2,Earnings_W_exp2,Earnings_E_exp2] = ...
        Graphs_Tables('exp2',r_exp2,w_exp2,mDBN_W_exp2,mDBN_E_exp2,mAp_W_exp2,mAp_E_exp2,OC_W_exp2,OC_E1_exp2,OC_E2_exp2,V_W_exp2,V_E_exp2,Transition_exp2) ;
