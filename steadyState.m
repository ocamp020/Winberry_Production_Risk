...
% Production risk economy
% Sergio Ocampo, August 24th, 2016
...
set(gcf,'color','w')
hold off
print('-depsc','SS_Consumption_m3.eps')
...
set(gcf,'color','w')
hold off
print('-depsc','SS_Unemployed_Distribution_m3.eps')
...
set(gcf,'color','w')
hold off
print('-depsc','SS_Employed_Distribution_m3.eps')
...
xlim([aaBar .9*assetsMax])
title('Invariant Distribution of Households (Employed)')
legend('Unemployed - Hist','Unemployed - Par','Employed - Hist','Employed - Par','location','northeast')
% grid on
set(gcf,'color','w')
hold off
print('-depsc','SS_Distribution_m3.eps')
